---
title: 'Kin Dependency Ratios: An Extension and Application of the Goodman Method
  for Estimating the Availability of Kin'
author:
...
To see XX
$$
l_{20}(t-20)m_{15}(t-20) + l_{15}(t-15)m_{20}(t-15) + l_{10}(t-10)m_{25}(t-10) + l_{5}(t-5)m_{30}(t-5) + l_{0}(t)m_{35}(t)
$$
